...
class Grades
{
    ...
    */
    public function amf_ping($obj = null)
    {
        ...
        $swf_return->service_version = '2010.02.01';
    ...
    */
    public function amf_grade_update($obj = null)
    {
        ...
        /* 
        $obj['userid'] = 2;
        $obj['instance'] = 27; // Course module ID, i.e. mod/swf/view.php?id=3
        $obj['swfid'] = 5; // SWF Activity Module ID
        ...
        */
        if(!$obj)
        {
            ...
            $swf_return->message = 'Module is incorrectly configured. No valid object was sent.';
            return $swf_return;
        }
        ...
        if ($capabilities->is_logged_in && $capabilities->view_own_grades)
        {
            ...
            /*if($grade->feedbackformat < 10) // Prevent Moodle's wiki formatting error - Doesn't work!
            {
                    $grade->feedbackformat == 10;
            }*/
