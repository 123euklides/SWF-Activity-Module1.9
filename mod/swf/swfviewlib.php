...
function swf_print_pairs($swf)
{
	...
	if($swf->name1 != '')
	{
		$swf_flashvar1 = 'flashvars.'.urlencode($swf->name1).' = "'.urlencode($swf->value1).'";';
	} else {
		$swf_flashvar1 = '';
	}
	// pair 2
	if($swf->name2 != '')
	{
		$swf_flashvar2 = 'flashvars.'.urlencode($swf->name2).' = "'.urlencode($swf->value2).'";';
	} else {
		$swf_flashvar2 = '';
	}
	// pair 3
	if($swf->name3 != '')
	{
		$swf_flashvar3 = 'flashvars.'.urlencode($swf->name3).' = "'.urlencode($swf->value3).'";';
	} else {
		$swf_flashvar3 = '';
	}
...
{
	$swf_div = '<div id="myAlternativeContent" align="center">
