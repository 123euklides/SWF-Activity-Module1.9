 ...
 */
	...
	*/
	...
	// dataroot file path WARNING! Experimental - Uncomment to activate.
	//$settings->add(new admin_setting_configtext('swf_dataroot', get_string('dataroot', 'swf'), get_string('datarootinfo', 'swf'), $CFG->dataroot, PARAM_TEXT));
	// moodledata file path WARNING! Experimental - Uncomment to activate.
	//$settings->add(new admin_setting_configtext('swf_wwwroot', get_string('wwwroot', 'swf'), get_string('wwwrootinfo', 'swf'), $CFG->wwwroot, PARAM_TEXT));
	//width
